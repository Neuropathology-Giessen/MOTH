...
QUPATH_PATH: str = 'test_projects/qp_project/project.qpproj' # generated by create_qp_project.ipynb
...
class TestTileImportExportCicle(unittest.TestCase):
    ...
    *no downsampling*
    ...
    def setUp(self):
        ...
        self.temporary_project: QuPathTilingProject = QuPathTilingProject(TEMPORARY_QP_PATH, 'x+')
...
class TestTileExport(unittest.TestCase):
    ...
    def setUp(self):
        self.qp_project: QuPathTilingProject = QuPathTilingProject(path = QUPATH_PATH, mode = 'r')
...
class TestTileImport(unittest.TestCase):
    ...
    def setUp(self):
        self.qp_project: QuPathTilingProject = QuPathTilingProject(path = QUPATH_PATH, mode = 'r')
        self.temp_qp_project: QuPathTilingProject = QuPathTilingProject(TEMPORARY_QP_PATH, 'x+')
    ...
    def test_label_img_to_polys(self):
        ...
        poly_with_class_single: List[Tuple[Union[Polygon, BaseGeometry], int]] = label_img_to_polys(
            self.expected_singlemask,
            downsample_level= 1,
            multichannel = False
        )
...
class TestTileUtils(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.qp_project: QuPathTilingProject = QuPathTilingProject(path = QUPATH_PATH, mode = 'r+')
        self.white_image: QuPathProjectImageEntry= self.qp_project.images[self.white_image_id]
        self.original_path_classes: Tuple[QuPathPathClass, ...] = self.qp_project.path_classes
