...
class TestTileImportExportCicle(unittest.TestCase):
    ...
    *no downsampling*
    '''
    def setUp(self):
        self.qp_project = QuPathTilingProject(qupath_path, 'r')
        self.temporary_project = QuPathTilingProject(temporary_qp_path, 'x+')
...
class TestTileExport(unittest.TestCase):
    ...
    def setUp(self):
        self.qp_project = QuPathTilingProject(path = qupath_path, mode = 'r')
    ...
    def test_get_tile(self):
        expected_tile = np.ones((50, 50, 3)) * 255
...
class TestTileImport(unittest.TestCase):
    ...
    def setUp(self):
        self.qp_project = QuPathTilingProject(path = qupath_path, mode = 'r')
        self.temp_qp_project = QuPathTilingProject(temporary_qp_path, 'x+')
